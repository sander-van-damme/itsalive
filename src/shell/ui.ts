...
export class ShellUI {
  ...
  private render(): void {
    this.mount.innerHTML = `<main class="shell">
      ...
      <aside class="rail">
        <header class="brand"><span class="brand-mark"><i data-lucide="sprout" size="16"></i></span><strong>itsalive</strong><span>runtime · v1</span></header>
  ...
  private renderApps(panel: HTMLElement): void {
    panel.innerHTML = `<header class="panel-head"><h2>Your apps</h2><p>Each app lives securely on its own subdomain.</p></header><div class="scroll">
      <button class="action primary" data-new style="width:100%"><i data-lucide="plus" size="14"></i> Create itsalive app</button>
  ...
  private showCreateForm(panel: HTMLElement): void {
    panel.innerHTML = `<header class="panel-head"><h2>New itsalive app</h2><p>Give your app a durable home and a clear purpose.</p></header><form class="scroll form" data-create>
