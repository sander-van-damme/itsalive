...
const WORKER_SYSTEM = [
  ...
  "",
  "OUTPUT",
  "Return only executable JavaScript commands between /* itsalive:command */ and /* itsalive:end */. The final command may call agent.done(...) only after your assigned scope works. Call it exactly once; returning agent.done(...) is preferred for clarity, although the runtime also recognizes a nested final call.",
  "",
  "SCOPE",
